...
if ( ! class_exists( 'RWMB_Show_Hide' ) )
{
	...
	class RWMB_Show_Hide
	{
		...
		{
			wp_enqueue_script( 'rwmb-show-hide', get_template_directory_uri().'/framework/meta-box/meta-box-extensions/meta-box-show-hide/show-hide.js', array( 'jquery' ), '0.1.0', true );
		}
	}
